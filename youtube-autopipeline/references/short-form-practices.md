...
- Use visual changes every few seconds: A-roll, PiP, stacked clips, B-roll, animated boards, mock UI, generated imagery, or full-screen text beats.
- Treat split-screen, two-stack, three-stack, four-grid, animated board captures, generated still motion, custom HTML captures, receipt highlights, kinetic text, before/after, myth/fact, and step-by-step/checklist sections as a non-ranked idea library. Choose by segment intent, not by fixed source priority.
...
- QA reports should include section-pattern variety, source-type variety, repeated canonical IDs, and static-frame risk.
