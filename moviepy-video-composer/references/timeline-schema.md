...
```json
{
  ...
  "layout": "fullscreen",
  "panels": [
    { "kind": "broll", "source_type": "stock", "path": "broll/B01.mp4" }
  ],
  "start_time": 5.0,
  "end_time": 10.0
}
...
```json
{
  ...
  "panels": [
    ...
    { "kind": "broll", "source_type": "generated-image", "path": "broll/generated/S02.png", "treatment": "still_motion" }
  ],
  "start_time": 16.0,
  "end_time": 21.0
}
...
Presenter panels do not have `source_type` and do not count as B-roll source diversity.
